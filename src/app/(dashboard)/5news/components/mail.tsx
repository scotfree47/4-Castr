  ...
  return (
    <TooltipProvider delayDuration={0}>
      <ResizablePanelGroup
        ...
        className="h-full w-full items-stretch rounded-lg border"
      >
        <ResizablePanel
        ...
        <ResizablePanel defaultSize={defaultLayout[1]} minSize={30}>
          <Tabs defaultValue="all" className="gap-1">
            ...
            <TabsContent value="all" className="m-0 animate-in fade-in slide-in-from-right-4 duration-500">
              <MailList items={mails} />
            </TabsContent>
            <TabsContent value="unread" className="m-0 animate-in fade-in slide-in-from-left-4 duration-500">
